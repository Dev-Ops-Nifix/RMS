...
const Performance = () => {
  ...
  // Class sections data with subject names added
  const classSections = [
    { name: '1-A', students: [{ id: 1, name: 'John Doe', grade: 'A', marks: 'IX' }, { id: 2, name: 'Jane Smith', grade: 'B', marks: 'VIII' }], performanceData: [
    ...
    { name: '1-B', students: [{ id: 3, name: 'Alex Brown', grade: 'C', marks: 'VII' }, { id: 4, name: 'Chris Green', grade: 'D', marks: 'VI' }], performanceData: [
    ...
    { name: '1-C', students: [{ id: 5, name: 'Emma Wilson', grade: 'A', marks: 'X' }, { id: 6, name: 'Liam Davis', grade: 'B', marks: 'IX' }], performanceData: [
    ...
    { name: '2-A', students: [{ id: 7, name: 'Olivia Taylor', grade: 'C', marks: 'VIII' }, { id: 8, name: 'Noah Miller', grade: 'B', marks: 'VII' }], performanceData: [
    ...
    { name: '2-B', students: [{ id: 9, name: 'Sophia Lee', grade: 'D', marks: 'VI' }, { id: 10, name: 'Mason Clark', grade: 'C', marks: 'V' }], performanceData: [
    ...
    { name: '2-C', students: [{ id: 11, name: 'Isabella Adams', grade: 'B', marks: 'VIII' }, { id: 12, name: 'Ethan King', grade: 'A', marks: 'IX' }], performanceData: [
    ...
    { name: '3-A', students: [{ id: 13, name: 'Ava Scott', grade: 'A', marks: 'X' }, { id: 14, name: 'James Hall', grade: 'B', marks: 'IX' }], performanceData: [
    ...
    { name: '3-B', students: [{ id: 15, name: 'Mia Young', grade: 'C', marks: 'VIII' }, { id: 16, name: 'Lucas Hill', grade: 'D', marks: 'VII' }], performanceData: [
    ...
    { name: '3-C', students: [{ id: 17, name: 'Charlotte Evans', grade: 'B', marks: 'IX' }, { id: 18, name: 'Henry Wright', grade: 'A', marks: 'X' }], performanceData: [
    ...
    { name: '4-A', students: [{ id: 19, name: 'Amelia Baker', grade: 'C', marks: 'VII' }, { id: 20, name: 'Benjamin Lewis', grade: 'B', marks: 'VIII' }], performanceData: [
    ...
    { name: '4-B', students: [{ id: 21, name: 'Harper Moore', grade: 'D', marks: 'VI' }, { id: 22, name: 'Elijah Walker', grade: 'C', marks: 'V' }], performanceData: [
    ...
    { name: '4-C', students: [{ id: 23, name: 'Evelyn Allen', grade: 'A', marks: 'IX' }, { id: 24, name: 'Daniel Turner', grade: 'B', marks: 'VIII' }], performanceData: [
    ...
    { name: '5-A', students: [{ id: 25, name: 'Abigail Green', grade: 'C', marks: 'VII' }, { id: 26, name: 'Michael Harris', grade: 'D', marks: 'VI' }], performanceData: [
    ...
    { name: '5-B', students: [{ id: 27, name: 'Emily Nelson', grade: 'B', marks: 'IX' }, { id: 28, name: 'William Carter', grade: 'A', marks: 'X' }], performanceData: [
    ...
    { name: '5-C', students: [{ id: 29, name: 'Elizabeth Mitchell', grade: 'C', marks: 'VIII' }, { id: 30, name: 'Alexander Parker', grade: 'B', marks: 'VII' }], performanceData: [
    ...
    { name: '6-A', students: [{ id: 31, name: 'Sofia Roberts', grade: 'A', marks: 'IX' }, { id: 32, name: 'Jameson Lee', grade: 'B', marks: 'VIII' }], performanceData: [
    ...
    { name: '6-B', students: [{ id: 33, name: 'Avery Cook', grade: 'C', marks: 'VII' }, { id: 34, name: 'Logan Bell', grade: 'D', marks: 'VI' }], performanceData: [
    ...
    { name: '6-C', students: [{ id: 35, name: 'Grace Ward', grade: 'B', marks: 'IX' }, { id: 36, name: 'Jackson Reed', grade: 'A', marks: 'X' }], performanceData: [
    ...
    { name: '7-A', students: [{ id: 37, name: 'Chloe Brooks', grade: 'C', marks: 'VIII' }, { id: 38, name: 'Samuel Gray', grade: 'B', marks: 'VII' }], performanceData: [
    ...
    { name: '7-B', students: [{ id: 39, name: 'Zoe Morgan', grade: 'D', marks: 'VI' }, { id: 40, name: 'Joseph Adams', grade: 'C', marks: 'V' }], performanceData: [
    ...
    { name: '7-C', students: [{ id: 41, name: 'Hannah Cooper', grade: 'A', marks: 'IX' }, { id: 42, name: 'David Kelly', grade: 'B', marks: 'VIII' }], performanceData: [
      { subject: 'Mathematics', pass: 80, average: 90 },
      { subject: 'Science', pass: 75, average: 87 },
      { subject: 'English', pass: 70, average: 84 },
      { subject: 'History', pass: 65, average: 81 },
    ...
    { name: '8-A', students: [{ id: 43, name: 'Lily Price', grade: 'C', marks: 'VII' }, { id: 44, name: 'Andrew Wood', grade: 'D', marks: 'VI' }], performanceData: [
      { subject: 'Mathematics', pass: 65, average: 80 },
    ...
    { name: '8-B', students: [{ id: 45, name: 'Ella Hughes', grade: 'B', marks: 'IX' }, { id: 46, name: 'Matthew Collins', grade: 'A', marks: 'X' }], performanceData: [
    ...
    { name: '8-C', students: [{ id: 47, name: 'Aria Bailey', grade: 'C', marks: 'VIII' }, { id: 48, name: 'Daniel Rivera', grade: 'B', marks: 'VII' }], performanceData: [
    ...
    { name: '9-A', students: [{ id: 49, name: 'Scarlett Gomez', grade: 'D', marks: 'VI' }, { id: 50, name: 'Thomas White', grade: 'C', marks: 'V' }], performanceData: [
    ...
    { name: '9-B', students: [{ id: 51, name: 'Penelope James', grade: 'B', marks: 'IX' }, { id: 52, name: 'Josephine Brown', grade: 'A', marks: 'X' }], performanceData: [
      { subject: 'Mathematics', pass: 70, average: 80 },
    ...
    { name: '9-C', students: [{ id: 53, name: 'Layla Davis', grade: 'C', marks: 'VIII' }, { id: 54, name: 'Henry Martinez', grade: 'B', marks: 'VII' }], performanceData: [
      { subject: 'Mathematics', pass: 65, average: 75 },
      { subject: 'Science', pass: 60, average: 72 },
      { subject: 'English', pass: 55, average: 69 },
      { subject: 'History', pass: 50, average: 66 },
    ...
    { name: '10-A', students: [{ id: 55, name: 'Victoria Garcia', grade: 'A', marks: 'IX' }, { id: 56, name: 'Gabriel Lopez', grade: 'B', marks: 'VIII' }], performanceData: [
      { subject: 'Mathematics', pass: 80, average: 90 },
      { subject: 'Science', pass: 75, average: 87 },
      { subject: 'English', pass: 70, average: 84 },
      { subject: 'History', pass: 65, average: 81 },
    ...
    { name: '10-B', students: [{ id: 57, name: 'Nora Perez', grade: 'C', marks: 'VII' }, { id: 58, name: 'Julian Smith', grade: 'D', marks: 'VI' }], performanceData: [
      { subject: 'Mathematics', pass: 70, average: 80 },
      { subject: 'Science', pass: 65, average: 77 },
      { subject: 'English', pass: 60, average: 74 },
      { subject: 'History', pass: 55, average: 71 },
    ...
    { name: '10-C', students: [{ id: 59, name: 'Eleanor Young', grade: 'B', marks: 'IX' }, { id: 60, name: 'Sebastian King', grade: 'A', marks: 'X' }], performanceData: [
      { subject: 'Mathematics', pass: 85, average: 92 },
      { subject: 'Science', pass: 80, average: 89 },
      { subject: 'English', pass: 75, average: 86 },
      { subject: 'History', pass: 70, average: 83 },
    ...
    { name: '10-D', students: [{ id: 61, name: 'Eleanor Young', grade: 'B', marks: 'IX' }, { id: 62, name: 'Sebastian King', grade: 'A', marks: 'X' }], performanceData: [
  ...
  {selectedClassSection.performanceData.map((stats, index) => (
    <div key={index} className="performance-card">
      <h4 style={{ marginBottom: '20px', marginTop: '20px', fontWeight: 'bold', backgroundColor: '#f3f4f6', padding: '5px 10px', borderRadius: '4px' }}>
        {stats.subject}
      </h4>
